...
* **Review the ```GeocodingPlugin.py``` file located in the ***Plugins*** directory**
  ...
  * Register the Plugin by adding the following code to the ```add_plugin(...)``` method in **chat.py**
